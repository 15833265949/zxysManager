...
import com.fh.service.patient.PatientShareDoctorService;
 ...
 */
@Controller
@RequestMapping("/patientShareDoctor")
public class PatientShareDoctorController extends BaseController {

	@Resource(name="patientShareDoctorService")
	private PatientShareDoctorService patientShareDoctorService;
	...
	public ModelAndView listDoctorActives(Page page) throws Exception {
		...
		//分页查询复合条件记录
		List<PageData> patientList = patientShareDoctorService.listPagePatientShareDoctor(page);
		
		
		
		mv.setViewName("patient/patientShare/patientShareDoctor_list");
